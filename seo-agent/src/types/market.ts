...
export interface KeywordMetrics {
  ...
  readonly averageCpcMicros: number | null
}
...
export type Row = readonly [url: string, title: string, snippet: string]

export const SEED_SERP: Readonly<Record<string, ReadonlyArray<Row>>> = {

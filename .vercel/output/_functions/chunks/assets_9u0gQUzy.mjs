import { A as ExpectedImageOptions, W as InvalidImageService, c as isRemotePath, j as ExpectedNotESMImage, k as ExpectedImage, ut as RemoteImageNotAllowed, v as inferRemoteSize, x as isRemoteAllowed, xt as AstroError } from "./path_Dp8OxFoI.mjs";
import { a as DEFAULT_HASH_PROPS, c as isRemoteImage, i as resolveDefaultOutputFormat, l as resolveSrc, n as isLocalService, s as isESMImportedImage } from "./service_CxcZUxOh.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_dVIFmK-n.mjs").catch((e) => {

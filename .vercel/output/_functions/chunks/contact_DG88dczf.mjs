...
import { r as Button } from "./site-footer_Do70HOEA.mjs";
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("span", {
				...
				children: [/* @__PURE__ */ jsx("h3", {
					...
					className: "rounded-full border border-brand-100 bg-accent px-2.5 py-0.5 text-xs font-bold text-accent-foreground num",
					children: ["#", refId]
				})]
			}), /* @__PURE__ */ jsx("p", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: FACTS.map(({ icon: Icon, title, desc }) => /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("span", {
						className: "grid size-9.5 shrink-0 place-items-center rounded-xl border border-brand-100 bg-accent text-primary",

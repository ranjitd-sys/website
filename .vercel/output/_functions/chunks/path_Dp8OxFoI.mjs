...
//#endregion
export { MissingSharp as $, ExpectedImageOptions as A, IncompatibleDescriptorOptions as B, ActionNotFoundError as C, isAstroError as Ct, ClientAddressNotAvailable as D, CacheNotEnabled as E, GetEntryDeprecationError as F, LocalImageUsedWrongly as G, InvalidGetStaticPathsEntry as H, GetStaticPathsExpectedParams as I, MiddlewareNoDataOrNextCalled as J, LocalsNotAnObject as K, GetStaticPathsInvalidRouteParam as L, FontFamilyNotFound as M, FontFileUrlNotFound as N, EndpointDidNotReturnAResponse as O, ForbiddenRewrite as P, MissingMediaQueryDirective as Q, GetStaticPathsRequired as R, matchPattern as S, AstroUserError as St, AstroResponseHeadersReassigned as T, InvalidGetStaticPathsReturn as U, InvalidComponentArgs as V, InvalidImageService as W, MissingGetFontFileRequestUrl as X, MiddlewareNotAResponse as Y, MissingImageDimension as Z, trimSlashes as _, UnknownContentCollectionError as _t, fileExtension as a, NoMatchingStaticPathFound as at, detector as b, i18nNoLocaleFoundInPath as bt, isRemotePath as c, PrerenderClientAddressNotAvailable as ct, removeBase as d, RenderUndefinedEntryError as dt, NoClientOnlyHint as et, removeLeadingForwardSlash as f, ReservedSlotName as ft, stripRequestBase as g, UnavailableAstroGlobal as gt, slash as h, StaticClientAddressNotAvailable as ht, collapseDuplicateTrailingSlashes as i, NoMatchingRenderer as it, ExpectedNotESMImage as j, ExpectedImage as k, joinPaths as l, PrerenderDynamicEndpointPathCollide as lt, removeTrailingForwardSlash as m, RewriteWithBodyUsed as mt, collapseDuplicateLeadingSlashes as n, NoManifestAvailable as nt, hasFileExtension as o, OnlyResponseCanBeReturned as ot, removeQueryString as p, ResponseSentError as pt, LocalsReassigned as q, collapseDuplicateSlashes as r, NoMatchingImport as rt, isInternalPath as s, PageNumberParamNotFound as st, appendForwardSlash as t, NoImageMetadata as tt, prependForwardSlash as u, RemoteImageNotAllowed as ut, inferRemoteSize as v, UnsupportedImageConversion as vt, ActionsReturnedInvalidDataError as w, isRemoteAllowed as x, AstroError as xt, fetchWithRedirects as y, UnsupportedImageFormat as yt, ImageMissingAlt as z };

import { C as ActionNotFoundError, Ct as isAstroError, D as ClientAddressNotAvailable, E as CacheNotEnabled, H as InvalidGetStaticPathsEntry, I as GetStaticPathsExpectedParams, J as MiddlewareNoDataOrNextCalled, K as LocalsNotAnObject, L as GetStaticPathsInvalidRouteParam, P as ForbiddenRewrite, R as GetStaticPathsRequired, S as matchPattern, St as AstroUserError, T as AstroResponseHeadersReassigned, U as InvalidGetStaticPathsReturn, Y as MiddlewareNotAResponse, _ as trimSlashes, a as fileExtension, at as NoMatchingStaticPathFound, bt as i18nNoLocaleFoundInPath, ct as PrerenderClientAddressNotAvailable, f as removeLeadingForwardSlash, ft as ReservedSlotName, g as stripRequestBase, h as slash$1, ht as StaticClientAddressNotAvailable, i as collapseDuplicateTrailingSlashes, l as joinPaths, lt as PrerenderDynamicEndpointPathCollide, m as removeTrailingForwardSlash, mt as RewriteWithBodyUsed, n as collapseDuplicateLeadingSlashes, nt as NoManifestAvailable, o as hasFileExtension, pt as ResponseSentError, q as LocalsReassigned, r as collapseDuplicateSlashes, s as isInternalPath, st as PageNumberParamNotFound, t as appendForwardSlash, u as prependForwardSlash, w as ActionsReturnedInvalidDataError, xt as AstroError } from "./chunks/path_Dp8OxFoI.mjs";
import { A as renderEndpoint, B as responseSentSymbol$1, E as pushDirective, F as REDIRECT_STATUS_CODES, H as decryptString, I as REROUTABLE_STATUS_CODES, L as clientAddressSymbol, M as ASTRO_ERROR_HEADER, N as ASTRO_GENERATOR, O as isAstroComponentFactory, P as DEFAULT_404_COMPONENT, R as fetchStateSymbol, T as normalizeCspResourceEntry, U as generateCspDigest, V as decodeKey, _ as isRenderTemplateResult, c as isRoute500, d as renderStreaming, g as renderSlotToString, l as renderJSX, m as createSlotValueFromString, n as createVNode, o as renderPage, p as chunkToString, s as isRoute404, t as AstroJSX, u as renderComponent, v as renderTemplate, w as isRenderInstruction, z as originPathnameSymbol } from "./chunks/jsx-runtime_6Vijajm9.mjs";
...
var middlewareSecret = "2bcef834-ab7a-4944-bb7c-ae85fb025cdc";
//#endregion
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/auth/github/callback.ts",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/api/auth/github/repos",
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/auth\\/github\\/repos\\/?$",
			"segments": [
				[{
					"content": "api",
					"dynamic": false,
			...
			"params": [],
			"component": "src/pages/api/auth/github/repos.ts",
			"pathname": "/api/auth/github/repos",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/api/auth/github/select-repo",
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/auth\\/github\\/select-repo\\/?$",
			"segments": [
				[{
					"content": "api",
					"dynamic": false,
			...
			"params": [],
			"component": "src/pages/api/auth/github/select-repo.ts",
			"pathname": "/api/auth/github/select-repo",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/auth/github/index.ts",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/api/careers/analyze-repo",
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/careers\\/analyze-repo\\/?$",
			"segments": [
				[{
					"content": "api",
					"dynamic": false,
			...
			"params": [],
			"component": "src/pages/api/careers/analyze-repo.ts",
			"pathname": "/api/careers/analyze-repo",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/api/careers/submit-quiz",
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/careers\\/submit-quiz\\/?$",
			"segments": [
				[{
					"content": "api",
					"dynamic": false,
			...
			"params": [],
			"component": "src/pages/api/careers/submit-quiz.ts",
			"pathname": "/api/careers/submit-quiz",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/careers/analysis-report",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/careers\\/analysis-report\\/?$",
			"segments": [[{
				"content": "careers",
				"dynamic": false,
				"spread": false
			...
			"params": [],
			"component": "src/pages/careers/analysis-report.astro",
			"pathname": "/careers/analysis-report",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/careers/index.astro",
			"pathname": "/careers",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["...slug"],
			"component": "src/pages/careers/[...slug].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
...
var _page0 = () => import("./chunks/generic_C8x50nCi.mjs");
var _page1 = () => import("./chunks/callback_BBMG4VQJ.mjs");
var _page2 = () => import("./chunks/repos_nIEvu-br.mjs");
var _page3 = () => import("./chunks/select-repo_Bo7D5xlW.mjs");
var _page4 = () => import("./chunks/index_B0_urSRh.mjs");
var _page5 = () => import("./chunks/logout_Ki-hr1oU.mjs");
var _page6 = () => import("./chunks/analyze-repo_CnzIAIvM.mjs");
var _page7 = () => import("./chunks/submit-quiz_GQIS-auz.mjs");
var _page8 = () => import("./chunks/index_7WQkdA1f.mjs");
var _page9 = () => import("./chunks/_.._CyAu0z6E.mjs");
var _page10 = () => import("./chunks/analysis-report_zv11FlJ5.mjs");
var _page11 = () => import("./chunks/index_D0PT7wJy.mjs");
var _page12 = () => import("./chunks/_.._CWHQ2Y9y.mjs");
var _page13 = () => import("./chunks/index_T8scuHXc.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
	["src/pages/api/auth/github/callback.ts", _page1],
	["src/pages/api/auth/github/repos.ts", _page2],
	["src/pages/api/auth/github/select-repo.ts", _page3],
	["src/pages/api/auth/github/index.ts", _page4],
	["src/pages/api/auth/logout.ts", _page5],
	["src/pages/api/careers/analyze-repo.ts", _page6],
	["src/pages/api/careers/submit-quiz.ts", _page7],
	["src/pages/blog/index.astro", _page8],
	["src/pages/blog/[...slug].astro", _page9],
	["src/pages/careers/analysis-report.astro", _page10],
	["src/pages/careers/index.astro", _page11],
	["src/pages/careers/[...slug].astro", _page12],
	["src/pages/index.astro", _page13]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///home/ranjit/Documents/deepecom/website/","cacheDir":"file:///home/ranjit/Documents/deepecom/website/node_modules/.astro/","outDir":"file:///home/ranjit/Documents/deepecom/website/dist/","srcDir":"file:///home/ranjit/Documents/deepecom/website/src/","publicDir":"file:///home/ranjit/Documents/deepecom/website/public/","buildClientDir":"file:///home/ranjit/Documents/deepecom/website/dist/client/","buildServerDir":"file:///home/ranjit/Documents/deepecom/website/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/auth/github/callback","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/auth\\/github\\/callback\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"auth","dynamic":false,"spread":false}],[{"content":"github","dynamic":false,"spread":false}],[{"content":"callback","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/auth/github/callback.ts","pathname":"/api/auth/github/callback","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/auth/github/repos","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/auth\\/github\\/repos\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"auth","dynamic":false,"spread":false}],[{"content":"github","dynamic":false,"spread":false}],[{"content":"repos","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/auth/github/repos.ts","pathname":"/api/auth/github/repos","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/auth/github/select-repo","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/auth\\/github\\/select-repo\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"auth","dynamic":false,"spread":false}],[{"content":"github","dynamic":false,"spread":false}],[{"content":"select-repo","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/auth/github/select-repo.ts","pathname":"/api/auth/github/select-repo","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/auth/github","isIndex":true,"type":"endpoint","pattern":"^\\/api\\/auth\\/github\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"auth","dynamic":false,"spread":false}],[{"content":"github","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/auth/github/index.ts","pathname":"/api/auth/github","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/auth/logout","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/auth\\/logout\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"auth","dynamic":false,"spread":false}],[{"content":"logout","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/auth/logout.ts","pathname":"/api/auth/logout","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/careers/analyze-repo","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/careers\\/analyze-repo\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"careers","dynamic":false,"spread":false}],[{"content":"analyze-repo","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/careers/analyze-repo.ts","pathname":"/api/careers/analyze-repo","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/careers/submit-quiz","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/careers\\/submit-quiz\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"careers","dynamic":false,"spread":false}],[{"content":"submit-quiz","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/careers/submit-quiz.ts","pathname":"/api/careers/submit-quiz","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":".grid-bg[data-astro-cid-yaoep7zk]{background-image:linear-gradient(90deg,#18181bcc 1px,#0000 1px),linear-gradient(#18181bcc 1px,#0000 1px);background-position:calc(50% + 6.14583rem) 0;background-size:12.2917rem 194px}.dithered-background-overlay[data-astro-cid-abafu6a3]{background-image:url(\"data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 width=%274%27 height=%274%27%3E%3Crect x=%270%27 y=%270%27 width=%271%27 height=%271%27 fill=%27white%27/%3E%3Crect x=%272%27 y=%272%27 width=%271%27 height=%271%27 fill=%27white%27/%3E%3C/svg%3E\");background-repeat:repeat;background-size:4px 4px}\n"},{"type":"external","src":"_astro/BaseLayout.BVx8uHo1.css"}],"routeData":{"route":"/blog","isIndex":true,"type":"page","pattern":"^\\/blog\\/?$","segments":[[{"content":"blog","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/blog/index.astro","pathname":"/blog","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":".grid-bg[data-astro-cid-yaoep7zk]{background-image:linear-gradient(90deg,#18181bcc 1px,#0000 1px),linear-gradient(#18181bcc 1px,#0000 1px);background-position:calc(50% + 6.14583rem) 0;background-size:12.2917rem 194px}.dithered-background-overlay[data-astro-cid-abafu6a3]{background-image:url(\"data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 width=%274%27 height=%274%27%3E%3Crect x=%270%27 y=%270%27 width=%271%27 height=%271%27 fill=%27white%27/%3E%3Crect x=%272%27 y=%272%27 width=%271%27 height=%271%27 fill=%27white%27/%3E%3C/svg%3E\");background-repeat:repeat;background-size:4px 4px}\n"},{"type":"external","src":"_astro/BaseLayout.BVx8uHo1.css"}],"routeData":{"route":"/blog/[...slug]","isIndex":false,"type":"page","pattern":"^\\/blog(?:\\/(.*?))?\\/?$","segments":[[{"content":"blog","dynamic":false,"spread":false}],[{"content":"...slug","dynamic":true,"spread":true}]],"params":["...slug"],"component":"src/pages/blog/[...slug].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.BVx8uHo1.css"}],"routeData":{"route":"/careers/analysis-report","isIndex":false,"type":"page","pattern":"^\\/careers\\/analysis-report\\/?$","segments":[[{"content":"careers","dynamic":false,"spread":false}],[{"content":"analysis-report","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/careers/analysis-report.astro","pathname":"/careers/analysis-report","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.BVx8uHo1.css"},{"type":"inline","content":".custom-scrollbar[data-astro-cid-usty5cq5]::-webkit-scrollbar{width:6px}.custom-scrollbar[data-astro-cid-usty5cq5]::-webkit-scrollbar-track{background:0 0}.custom-scrollbar[data-astro-cid-usty5cq5]::-webkit-scrollbar-thumb{background-color:#3f3f46;border-radius:10px}.custom-scrollbar[data-astro-cid-usty5cq5]::-webkit-scrollbar-thumb:hover{background-color:#52525b}\n"}],"routeData":{"route":"/careers","isIndex":true,"type":"page","pattern":"^\\/careers\\/?$","segments":[[{"content":"careers","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/careers/index.astro","pathname":"/careers","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.BVx8uHo1.css"}],"routeData":{"route":"/careers/[...slug]","isIndex":false,"type":"page","pattern":"^\\/careers(?:\\/(.*?))?\\/?$","segments":[[{"content":"careers","dynamic":false,"spread":false}],[{"content":"...slug","dynamic":true,"spread":true}]],"params":["...slug"],"component":"src/pages/careers/[...slug].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/index.BOqjcC3_.css"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","site":"http://localhost:4321","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["/home/ranjit/Documents/deepecom/website/src/pages/blog/[...slug].astro",{"propagation":"none","containsHead":true}],["/home/ranjit/Documents/deepecom/website/src/pages/blog/index.astro",{"propagation":"none","containsHead":true}],["/home/ranjit/Documents/deepecom/website/src/pages/careers/[...slug].astro",{"propagation":"none","containsHead":true}],["/home/ranjit/Documents/deepecom/website/src/pages/careers/analysis-report.astro",{"propagation":"none","containsHead":true}],["/home/ranjit/Documents/deepecom/website/src/pages/careers/index.astro",{"propagation":"none","containsHead":true}],["/home/ranjit/Documents/deepecom/website/src/pages/index.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","/home/ranjit/Documents/deepecom/website/node_modules/@astrojs/react/dist/vnode-children.js":"chunks/vnode-children_B6vVcKTz.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:src/pages/careers/[...slug]@_@astro":"chunks/_.._CWHQ2Y9y.mjs","\u0000virtual:astro:page:src/pages/blog/[...slug]@_@astro":"chunks/_.._CyAu0z6E.mjs","\u0000astro:data-layer-content":"chunks/_astro_data-layer-content_DBtbyAdG.mjs","\u0000virtual:astro:get-image":"chunks/_virtual_astro_get-image_cDWwEX2y.mjs","\u0000virtual:astro:page:src/pages/careers/analysis-report@_@astro":"chunks/analysis-report_zv11FlJ5.mjs","\u0000virtual:astro:page:src/pages/api/careers/analyze-repo@_@ts":"chunks/analyze-repo_CnzIAIvM.mjs","\u0000virtual:astro:page:src/pages/api/auth/github/callback@_@ts":"chunks/callback_BBMG4VQJ.mjs","/home/ranjit/Documents/deepecom/website/.astro/content-assets.mjs":"chunks/content-assets_DXqEyLLP.mjs","/home/ranjit/Documents/deepecom/website/.astro/content-modules.mjs":"chunks/content-modules_I7QRxwaA.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_C8x50nCi.mjs","\u0000virtual:astro:page:src/pages/blog/index@_@astro":"chunks/index_7WQkdA1f.mjs","\u0000virtual:astro:page:src/pages/api/auth/github/index@_@ts":"chunks/index_B0_urSRh.mjs","\u0000virtual:astro:page:src/pages/careers/index@_@astro":"chunks/index_D0PT7wJy.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_T8scuHXc.mjs","\u0000virtual:astro:page:src/pages/api/auth/logout@_@ts":"chunks/logout_Ki-hr1oU.mjs","\u0000virtual:astro:page:src/pages/api/auth/github/repos@_@ts":"chunks/repos_nIEvu-br.mjs","\u0000virtual:astro:page:src/pages/api/auth/github/select-repo@_@ts":"chunks/select-repo_Bo7D5xlW.mjs","/home/ranjit/Documents/deepecom/website/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_dVIFmK-n.mjs","\u0000virtual:astro:page:src/pages/api/careers/submit-quiz@_@ts":"chunks/submit-quiz_GQIS-auz.mjs","@/components/blog/BlogControls":"_astro/BlogControls.BHBqIMby.js","@/components/blog/CopyLinkButton":"_astro/CopyLinkButton.B-uelu8o.js","/home/ranjit/Documents/deepecom/website/src/layouts/LandingLayout.astro?astro&type=script&index=0&lang.ts":"_astro/LandingLayout.astro_astro_type_script_index_0_lang.UcUOMvwt.js","/home/ranjit/Documents/deepecom/website/src/components/navigation/NavigationMobileMenu.astro?astro&type=script&index=0&lang.ts":"_astro/NavigationMobileMenu.astro_astro_type_script_index_0_lang.BaeMLpLB.js","/home/ranjit/Documents/deepecom/website/src/components/navigation/SearchDialogIsland.tsx":"_astro/SearchDialogIsland.Fuhl4oTR.js","@/components/navigation/SearchTriggerIsland":"_astro/SearchTriggerIsland.CtMyG5OA.js","@/components/blog/TWIEScrollRail":"_astro/TWIEScrollRail.DjuaEJuu.js","@/components/blog/TableOfContents":"_astro/TableOfContents.DSdejHaN.js","@/components/ui/ThemeToggle":"_astro/ThemeToggle.ByxQlkNJ.js","@astrojs/react/client.js":"_astro/client.CgoVBPdJ.js","/home/ranjit/Documents/deepecom/website/src/components/landing/contact-form.tsx":"_astro/contact-form.CH9KGSNF.js","/home/ranjit/Documents/deepecom/website/src/components/landing/faq-accordion.tsx":"_astro/faq-accordion.BsNZkGpP.js","/home/ranjit/Documents/deepecom/website/src/pages/careers/index.astro?astro&type=script&index=0&lang.ts":"_astro/index.astro_astro_type_script_index_0_lang.DSaYCjEA.js","/home/ranjit/Documents/deepecom/website/src/components/landing/integrations-tabs.tsx":"_astro/integrations-tabs.Ooh95oBk.js","/home/ranjit/Documents/deepecom/website/src/components/landing/kpi-value.tsx":"_astro/kpi-value.CFcp78cy.js","@/components/landing/site-nav":"_astro/site-nav.vR6qkIIE.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["/home/ranjit/Documents/deepecom/website/src/layouts/LandingLayout.astro?astro&type=script&index=0&lang.ts","var e=new IntersectionObserver(t=>{for(let n of t){if(!n.isIntersecting)continue;let t=n.target;t.style.transitionDelay=`${t.dataset.delay??0}ms`,t.classList.add(`in`),e.unobserve(t)}},{threshold:.12,rootMargin:`0px -32px 0px 0px`});document.querySelectorAll(`.reveal`).forEach(t=>e.observe(t));var t=document.getElementById(`mobile-cta`);if(t){let e=()=>t.classList.toggle(`translate-y-full`,window.scrollY<560);e(),window.addEventListener(`scroll`,e,{passive:!0})}"],["/home/ranjit/Documents/deepecom/website/src/pages/careers/index.astro?astro&type=script&index=0&lang.ts","var e=document.getElementById(`repo-select`),t=document.getElementById(`save-repo-btn`),n=document.getElementById(`change-repo-btn`),r=document.getElementById(`run-analysis-btn`);e&&fetch(`/api/auth/github/repos`).then(e=>e.json()).then(t=>{e.innerHTML=`<option value=\"\">-- Select GitHub Repository --</option>`,t.forEach(t=>{let n=document.createElement(`option`);n.value=t.fullName,n.textContent=`${t.fullName} ${t.private?`[Private]`:``}`,e.appendChild(n)})}).catch(()=>{e.innerHTML=`<option value=\"\">Failed to fetch repositories</option>`}),t?.addEventListener(`click`,async()=>{let t=e?.value;if(!t)return alert(`Please select a repository from the list.`);(await fetch(`/api/auth/github/select-repo`,{method:`POST`,headers:{\"Content-Type\":`application/json`},body:JSON.stringify({repoFullName:t})})).ok&&window.location.reload()}),n?.addEventListener(`click`,async()=>{(await fetch(`/api/auth/github/select-repo`,{method:`POST`,headers:{\"Content-Type\":`application/json`},body:JSON.stringify({repoFullName:``})})).ok&&window.location.reload()}),r?.addEventListener(`click`,async()=>{r.setAttribute(`disabled`,`true`),r.innerHTML=`\n      <svg class=\"animate-spin -ml-1 mr-2 h-4 w-4 text-black inline-block\" xmlns=\"http://www.w3.org/2000/svg\" fill=\"none\" viewBox=\"0 0 24 24\"><circle class=\"opacity-25\" cx=\"12\" cy=\"12\" r=\"10\" stroke=\"currentColor\" stroke-width=\"4\"></circle><path class=\"opacity-75\" fill=\"currentColor\" d=\"M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z\"></path></svg>\n      Analyzing Codebase...\n    `;try{let e=await fetch(`/api/careers/analyze-repo`,{method:`POST`}),t=await e.json();if(e.ok&&t.success){let e=document.getElementById(`analysis-output`),n=document.getElementById(`file-count-badge`),i=document.getElementById(`file-list`);e&&i&&n&&t.files&&(n.textContent=`${t.fileCount} files`,i.innerHTML=``,t.files.forEach(e=>{let t=document.createElement(`li`);t.className=`py-2.5 px-4 text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800/30 transition-colors flex items-center gap-3`,t.innerHTML=`<svg class=\"w-3.5 h-3.5 text-zinc-600 shrink-0\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z\" /></svg> <span class=\"truncate\">${e.path}</span>`,i.appendChild(t)}),e.classList.remove(`hidden`)),r.innerHTML=`Analysis Complete ✓`,setTimeout(()=>window.location.reload(),2500)}else alert(t.error||`Failed to execute repository analysis.`),r.removeAttribute(`disabled`),r.innerText=`Run Analysis Pipeline`}catch{alert(`Error executing repository analysis pipeline.`),r.removeAttribute(`disabled`),r.innerText=`Run Analysis Pipeline`}});"]],"assets":["/logo.svg","/_astro/BlogControls.BHBqIMby.js","/_astro/CopyLinkButton.B-uelu8o.js","/_astro/Hooks.D79XQF8S.js","/_astro/MixedbreadLogo.BiswM2LG.svg","/_astro/NavigationMobileMenu.astro_astro_type_script_index_0_lang.BaeMLpLB.js","/_astro/SearchDialogIsland.Fuhl4oTR.js","/_astro/SearchTriggerIsland.CtMyG5OA.js","/_astro/TWIEScrollRail.DjuaEJuu.js","/_astro/TableOfContents.DSdejHaN.js","/_astro/ThemeToggle.ByxQlkNJ.js","/_astro/bundle-mjs.B_AA55HL.js","/_astro/button.AJ5ZG4lA.js","/_astro/check.C2r6gmSY.js","/_astro/chevron-right.DoiYa8Au.js","/_astro/client.CgoVBPdJ.js","/_astro/contact-form.CH9KGSNF.js","/_astro/createLucideIcon.DIO4-i-G.js","/_astro/faq-accordion.BsNZkGpP.js","/_astro/integrations-tabs.Ooh95oBk.js","/_astro/jsx-runtime.5oAs05S-.js","/_astro/kpi-value.CFcp78cy.js","/_astro/navigation.BitKJtrt.js","/_astro/react-dom.DjmvpWmh.js","/_astro/react.Od-laFSK.js","/_astro/scheduler._4-pCGWv.js","/_astro/search.0B7-DfWe.js","/_astro/site-nav.vR6qkIIE.js","/_astro/use-animate.DwzU0Zgm.js","/_astro/useOpenChangeComplete.BmR9VUsP.js","/_astro/useRenderElement.DLE0cLO3.js","/_astro/utils.23KeWczG.js","/_astro/fonts/63515b4a3122509a.woff2","/_astro/fonts/91753f8d8da3aeb7.woff2","/_astro/fonts/d7e4d72475f7808f.woff2","/_astro/fonts/e868cdf4720e9ea5.woff2","/_astro/davide_scognamiglio.Cl1xN8tM.png","/_astro/giulio_canti.Bt06Wwol.png","/_astro/maxwell_brown.B_dLvuVP.png","/_astro/tim_smart.D8uSEK6D.png","/_astro/michael_arnaldi.DqnwJYZH.png","/_astro/mirela_prifti.BOMzyQMY.png","/_astro/LinkedIn.CGdDTNQQ.svg","/_astro/TwitterWhite.y-nUWerV.svg","/_astro/effect-logo-black.CJ9hFWX7.svg","/_astro/effect-logo-white.Yu0soJEa.svg","/_astro/Discord.IWvshbXt.svg","/_astro/GitHub.Cxf3JvoV.svg","/_astro/Twitter.BET-TmQF.svg","/_astro/YouTube.DsOSr2zl.svg","/_astro/BlueSky.ubAYhTaL.svg","/_astro/Spotify.gsQFTkBN.svg","/_astro/BaseLayout.BVx8uHo1.css","/_astro/index.BOqjcC3_.css"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"FnMRK1zTc3P30I5TuuG1YV6bssGZ9ctwv9h/yYIa/so=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "2bcef834-ab7a-4944-bb7c-ae85fb025cdc") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
